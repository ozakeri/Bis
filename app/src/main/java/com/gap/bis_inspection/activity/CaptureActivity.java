...
import com.gap.bis_inspection.util.ImageDialog;
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                new AsyncTask<byte[], Void, File>() {
                    ...
                    protected void onPreExecute() {
                        super.onPreExecute();
                        progressDialog = new CustomProgressDialog(CaptureActivity.this);
                    ...
                    protected void onPostExecute(File file) {
                        ...
                        if (file == null) {
                            ...
                            ImageDialog dialog = new ImageDialog(CaptureActivity.this, file);
